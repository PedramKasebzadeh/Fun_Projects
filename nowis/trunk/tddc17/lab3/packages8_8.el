...
(define (problem C3_2)
  ...
  (:objects
   ...
   packet5 packet6 packet7 packet8   ;; four packages (no need to move)
  )

  (:init
   ;; Type declarations:
   (object packet1) (object packet2) (object packet3) (object packet4)
   (object packet5) (object packet6) (object packet7) (object packet8)
   (small_s packet1) (small_s packet2) (big_s packet3) (big_s packet4)
   (small_s packet5) (small_s packet6) (big_s packet7) (big_s packet8)
   ...
   (at packet3 office4)
   (at packet4 office3)
   (at packet5 trainStation4)
   (at packet6 office3)
   (at packet7 airport1)
   (at packet8 trainStation3)
   (at truck1 airport1)
   (at truck2 airport2)
   (at truck3 office3)
  ...
  (:goal (and (at packet1 office2) (at packet2 office2) (at packet3 office1)
              (at packet4 office2) (at packet5 office1) (at packet6 office4)
              (at packet7 office1) (at packet8 airport1)
         )
  )
)
